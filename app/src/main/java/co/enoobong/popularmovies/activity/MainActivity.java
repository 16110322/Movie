...
public class MainActivity extends AppCompatActivity {
    ...
    private void getPopularMovies() {
        Call<JsonObject> call = API_INTERFACE.getPopularMovies(getString(R.string.80346611992183eab3cf10662f0080af), 1);
    ...
    private void getTopRatedMovies() {
        Call<JsonObject> call = API_INTERFACE.getTopRatedMovies(getString(R.string.80346611992183eab3cf10662f0080af), 1);
        call.enqueue(new Callback<JsonObject>() {
            @Override
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                mMovieList = new Gson().fromJson(response.body().getAsJsonArray("results"), TYPE);
